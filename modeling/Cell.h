...
public:
	...
	double new_temperature = 0; // the cell temperature is calculated in the last step
	double old_temperature = 0; // cell temperature, which will be calculated in the next step
