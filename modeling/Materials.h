...
static Material Titanium([](double temperature) {return 0.66995 * 1.e-6; },
				[](double temperature) {return 4.54 * 1.e3; },
				[](double temperature) {return 540.; },
				[](double temperature) {return 21.9; },
				ST_SOLID);

static Material Copper([](double temperature) {return 0.01724 * 1.e-6; },
