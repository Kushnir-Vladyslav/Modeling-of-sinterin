...
Calculation_of_currents_Gauss::Calculation_of_currents_Gauss(int width, int height) : Wind(L"Current distribution", 500, 500), width(width), height(height)
{
...
void Calculation_of_currents_Gauss::Culculation(Cell** arr_of_cells, double potential_difference, bool is_draw_wind)
{
...
void Calculation_of_currents_Gauss::Draw_wind(Cell** arr_of_cells)
{
	double min_c = 99999;
	double max_c = 0;
